...
export default function HeroBanner() {
  return (
    <section className="w-full py-10 flex flex-col justify-center items-center text-center px-6 md:px-12 bg-gradient-to-b from-zinc-300 to-zinc-100 text-neutral-900 shadow-lg rounded-lg mt-20 mb-5">
